...
mongo_db_location = os.environ.get("MONGOLAB_URI","mongodb://vebsuser:vebsuser@localhost:27017/vebsiam2") 
...
SECRET_KEY = 'pacb(vt+$h^ah(g)l6osw+z9u9j*h#an&amp;t0xayxcmo5ef&amp;q67g'
